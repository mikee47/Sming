...
int IRAM_ATTR __attribute__((weak)) get_adc_mode()
{
	return 33;
}

int IRAM_ATTR __attribute__((weak)) custom_register_chipv6_phy(uint8_t* initData)
{
	if (initData != NULL) {
...
int __wrap_register_chipv6_phy(uint8_t* initData) __attribute__ ((alias("custom_register_chipv6_phy")));
