...
public:
	...
	bool begin(imu_com_fptr_t read_callblack, imu_com_fptr_t write_callblack,
			   mpu6050_dps_t scale = MPU6050_SCALE_2000DPS, mpu6050_range_t range = MPU6050_RANGE_2G,
			   int mpua = MPU6050_ADDRESS);
