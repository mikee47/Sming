PYTHON_REQUIREMENTS := $(IDF_PATH)/requirements.txt
...
$(SDKCONFIG_H) $(SDK_COMPONENT_LIBS) $(SDK_BUILD_COMPLETE): $(SDK_CONFIG_DEFAULTS) | $(SDK_BUILD_BASE) $(SDK_COMPONENT_LIBDIR)
	$(Q) $(SDK_BUILD) reconfigure bootloader app
