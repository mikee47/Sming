 ...
 */
bool MPR121_Class::begin(uint8_t i2caddr, TwoWire* theWire, uint8_t touchThreshold, uint8_t releaseThreshold)
{
	_i2caddr = i2caddr;
	_wire = theWire;
	_wire->begin();
...
bool MPR121_Class::begin(i2c_com_fptr_t r, i2c_com_fptr_t w, uint8_t addr, uint8_t touchThreshold,
...
bool MPR121_Class::init(uint8_t touchThreshold, uint8_t releaseThreshold)
{
	...
	byte ECR_SETTING = B10000000 + 12; // 5 bits for baseline tracking & proximity disabled + X
